        ...
        <div class="day-summary">
          <div class="summary-header">
            <div class="ribbon-container">
              <img src = "@/assets/bank/Ribbon.png" alt="Ribbon" class=""ribbon-image>
...
.bank-container {
  ...
  background-image: url("@/assets/bank/bankbg.png");
...
.calandar {
  ...
  width: 1025px;
  height: 525px;
  background-image: url("@/assets/bank/calendar.png");
...
/* ✅ 버튼의 기본 스타일 제거 */
.loan-btn1 {
  background: url("@/assets/bank/loan-btn.png") no-repeat center;
  background-size: contain;
  display: block;
  width: 186px;
  height: 76px;
...
/* ✅ 나가기 버튼 */
.exit-btn {
  background: url("@/assets/bank/Getout.png") no-repeat center;
  background-size: contain;
  display: block;
  width: 250px; /* ✅ 크기 조정 */
  height: 90px; /* ✅ 크기 조정 */
